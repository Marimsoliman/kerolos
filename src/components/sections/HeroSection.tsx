...
const FADE_MASK_MOBILE =
  "linear-gradient(to bottom, #000 0%, #000 85%, rgba(0,0,0,0.4) 92%, transparent 100%)";
      ...
      <motion.div className="relative z-10 w-full max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20" style={{ opacity: contentOpacity, y: contentY }}>
        ...
        <div className="md:hidden flex flex-col items-center text-center min-h-screen pt-0 pb-8">
          ...
          <div className="mt-4 w-full px-4">
            ...
            <div className="grid grid-cols-3 w-full max-w-[300px] mx-auto mt-6 border-t border-white/10 pt-5">
              {[{ v: "150+", l: "Projects" }, { v: "150+", l: "Clients" }, { v: "5+", l: "Years" }].map((s,i)=>(
